...
def q_z2_given_z1y(z1, y, latent_dim, num_classes, hidden_dim, reuse=False):
...
def qy_given_z1(z1, latent_dim, hidden_dim, num_classes, reuse=False):
    with tf.variable_scope("y_classifier", reuse=reuse):
        w_mlp_h1, b_mlp_h1 = create_nn_weights('y_h1', 'infer', [latent_dim, hidden_dim])
